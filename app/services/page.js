...
export default function Services() {
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24 max-w-[1440px] mx-auto">
      ...
      <p className="max-w-[1000px] -mb-4 text-lg  text-neutral-700">
      ...
      <section className="flex flex-col gap-10 my-10 md:flex-row ">
        ...
        <div class="h-[250px] min-h-[2em] w-0.5 self-stretch bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-100"></div>
        <div className="flex flex-col items-center justify-center text-center">
