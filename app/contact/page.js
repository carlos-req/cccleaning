      ...
      <form className="w-full max-w-lg ">
        ...
        <div className="flex flex-wrap mb-6 -mx-3">
          <div className="w-full px-3">
            ...
            <textarea className="block w-full h-48 px-4 py-3 mb-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none no-resize focus:outline-none focus:bg-white focus:border-gray-500"></textarea>
            <p className="text-xs italic text-gray-600">
